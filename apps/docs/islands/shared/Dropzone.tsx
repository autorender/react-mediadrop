	...
	return (
		<div
			...
			className={cn(
				...
				active && "border-sky-500 bg-zinc-100 dark:border-sky-400 dark:bg-zinc-900",
				accept && "border-green-500 bg-green-50 dark:border-green-400 dark:bg-green-950/30",
				reject && "border-red-500 bg-red-50 dark:border-red-400 dark:bg-red-950/30",
